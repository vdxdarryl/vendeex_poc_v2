...
(function () {
  ...
  var STRINGS = {
    ...
    en: {
      ...
      'demo.heroTitle':     'Experience VendeeX<br>Agentic Commerce Trust Infrastructure',
      ...
      'reg.credential':     'In this PoC, we do not collect any information about you. In fact you can enter any name and email you want to create an Avatar. What we want you to experience is how the Vendee Avatar applies governance rules to your purchasing, not just preferences.',
    ...
    zh: {
      ...
      'demo.heroTitle':     '体验VendeeX<br>代理商务信任基础设施',
      ...
      'reg.credential':     '在此概念验证中，我们不收集您的任何信息。实际上，您可以输入任何姓名和电子邮件来创建数字分身。我们希望您体验的是Vendee数字分身如何将治理规则应用于您的购买决策，而不仅仅是偏好设置。',
